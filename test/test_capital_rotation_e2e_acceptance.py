...
class CapitalRotationAcceptanceTests(unittest.TestCase):
    ...
    def test_portal_import_workflow_is_scheduled_attestation_bound_and_fail_closed(self):
        ...
        self.assertIn("environment: atlas-portal-dispatch", text)
        self.assertIn("GH_TOKEN: ${{ secrets.ATLAS_PORTAL_DISPATCH_TOKEN }}", text)
        self.assertIn('gh repo clone yonggeun1021-hub/atlas-portal "$PORTAL_ROOT" -- --quiet', text)
        self.assertNotIn("https://github.com/yonggeun1021-hub/atlas-portal.git", text)
