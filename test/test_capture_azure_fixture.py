...
print("A-2 중첩 표 — 가장 안쪽 데이터 표를 고른다")
...
print("A-4 다른 reconciliation 표가 같이 있어도 대상만 고른다")
...
print("A-5 fail-closed — 모호하거나 없으면 만들지 않는다")
NEG = {
...
print("A-6 ★ 제목이 별도 표 안에 있어 균형이 깨지는 경우 — fallback 이 실제로 동작한다")
...
print("A-7 ★ 닫힌 열거 — 미지의 문면은 통과시키지 않는다")
UNKNOWN_TITLES = [
...
print("A-8 저장 직전 집행 — slice_and_verify")
