...
- 생성 시각(UTC): 2026-09-08T09:56:20Z
- 운영일(KST): 2026-09-08
- 원본 브리지 생성 ID: 8eede07b60ab3b725d9d124572c09b9c5942781bf141b2fc24d2dddeb9804275
- 원본 브리지 payload_sha256: 76dbef49dea5598b1e1bf1ef720d8e543faf307f36a7980330e9ad8204935067
...
| --- | --- | --- | --- | --- | --- |
| 추세(TREND) | 확보됨(DEFINED) | 2026-09-07 | 2026-09-08T00:42:02Z | 아니오 | REGIME_INTERPRETATION_UNAUTHORIZED |
| 위험·변동성(RISK_VOL) | 확보됨(DEFINED) | 2026-09-07 | 2026-09-08T00:42:02Z | 아니오 | REGIME_INTERPRETATION_UNAUTHORIZED, STRESS_THRESHOLDS_UNCALIBRATED |
| 유동성(LIQUIDITY) | 확보됨(DEFINED) | 2026-09-08 | 2026-09-08T06:38:27Z | 아니오 | CRYPTO_LIQUIDITY_UPBIT_MICROSTRUCTURE_INPUT_UNAVAILABLE, REGIME_INTERPRETATION_UNAUTHORIZED |
| 시장 폭(BREADTH) | 미확보(UNDEFINED) | - | - | 예 | LIVE_AXIS_EVIDENCE_UNAVAILABLE |
...
- 진입 사유 `OFFICIAL_AXES_INCOMPLETE:BREADTH,LEADERSHIP`: 공식 5개 축 가운데 BREADTH,LEADERSHIP이(가) 아직 미확보라 신규 진입이 보류된다.
- 진입 사유 `AGGREGATE_POLICY_UNRATIFIED`: 종합 Regime 방향·임계값 정책이 아직 비준되지 않아 신규 진입은 매수대기로 제한된다.
- 진입 보류 축 `BREADTH`: 시장 폭(BREADTH) 축이 미확보라 이 종목의 신규 진입이 보류된다.
