...
- 생성 시각(UTC): 2026-09-19T17:45:03Z
- 운영일(KST): 2026-09-20
- 원본 브리지 생성 ID: 75a84cc19f7ceeb254c79359b430842f32024fee60868ab506966148ba366060
- 원본 브리지 payload_sha256: 8f957d2333939af026c02774229e5cda95db86146553935c004c7e0088f5b3de
...
| --- | --- | --- | --- | --- | --- |
| 추세(TREND) | 확보됨(DEFINED) | 2026-09-18 | 2026-09-19T04:44:38Z | 아니오 | REGIME_INTERPRETATION_UNAUTHORIZED |
| 위험·변동성(RISK_VOL) | 확보됨(DEFINED) | 2026-09-18 | 2026-09-19T04:44:38Z | 아니오 | REGIME_INTERPRETATION_UNAUTHORIZED, STRESS_THRESHOLDS_UNCALIBRATED |
| 유동성(LIQUIDITY) | 확보됨(DEFINED) | 2026-09-19 | 2026-09-19T06:25:55Z | 아니오 | CRYPTO_LIQUIDITY_UPBIT_MICROSTRUCTURE_INPUT_UNAVAILABLE, REGIME_INTERPRETATION_UNAUTHORIZED |
| 시장 폭(BREADTH) | 확보됨(DEFINED) | 2026-09-18 | 2026-09-19T01:11:01Z | 아니오 | REGIME_INTERPRETATION_UNAUTHORIZED |
...
- (없음) 사유 `NO_SYMBOL_IN_THIS_STAGE`: 이번 세대에는 이 단계로 분류된 종목이 없다.
...
- 단계: 매수대기 (`WAIT`)
- 상류 판정: `WATCH` / `T2_REQUIRED_UNKNOWN:T2_REGIME_PERMITS_NEW_BUYS,T2_ROTATION_MEMBERSHIP`
- 진입 사유 `UPSTREAM_STATE:WATCH`: 상류 P5-08/P5-09 판정 상태는 WATCH이다.
- 진입 사유 `OFFICIAL_AXES_INCOMPLETE:LEADERSHIP`: 공식 5개 축 가운데 LEADERSHIP이(가) 아직 미확보라 신규 진입이 보류된다.
