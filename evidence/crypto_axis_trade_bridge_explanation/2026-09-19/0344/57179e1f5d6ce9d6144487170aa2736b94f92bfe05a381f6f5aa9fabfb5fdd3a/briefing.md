...
- 생성 시각(UTC): 2026-09-19T03:44:11Z
- 운영일(KST): 2026-09-19
- 원본 브리지 생성 ID: 57179e1f5d6ce9d6144487170aa2736b94f92bfe05a381f6f5aa9fabfb5fdd3a
- 원본 브리지 payload_sha256: ce80b777970e947bfc62eafe22e50f7d589880ad3819610d47e3617ba011ab51
...
| --- | --- | --- | --- | --- | --- |
| 추세(TREND) | 미확보(UNDEFINED) | - | - | 예 | LIVE_AXIS_EVIDENCE_UNAVAILABLE |
| 위험·변동성(RISK_VOL) | 미확보(UNDEFINED) | - | - | 예 | LIVE_AXIS_EVIDENCE_UNAVAILABLE |
...
- 진입 사유 `OFFICIAL_AXES_INCOMPLETE:TREND,RISK_VOL,LIQUIDITY,LEADERSHIP`: 공식 5개 축 가운데 TREND,RISK_VOL,LIQUIDITY,LEADERSHIP이(가) 아직 미확보라 신규 진입이 보류된다.
- 진입 사유 `AGGREGATE_POLICY_UNRATIFIED`: 종합 Regime 방향·임계값 정책이 아직 비준되지 않아 신규 진입은 매수대기로 제한된다.
- 진입 보류 축 `TREND`: 추세(TREND) 축이 미확보라 이 종목의 신규 진입이 보류된다.
- 진입 보류 축 `RISK_VOL`: 위험·변동성(RISK_VOL) 축이 미확보라 이 종목의 신규 진입이 보류된다.
