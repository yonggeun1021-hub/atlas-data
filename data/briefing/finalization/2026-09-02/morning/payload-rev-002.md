# Atlas Daily Briefing — 2026-09-02 (morning)

복구 유형: MANUAL_RECOVERY · 자연 실행 표본 아님
...
확인된 사실:
- 미 중부사령부는 9월 1일 이란 내 IRGC 방공·레이더·해상 자산과 시설·기뢰 부설 능력·통신 시설에 대한 타격을 완료했다고 발표했습니다.
- AP는 미군 타격 뒤 이란이 역내 여러 지점을 향해 미사일과 드론으로 보복했다고 보도했습니다.

상황평가:
- 확인된 상호 공격은 중동 지정학 위험이 다시 확대됐다는 상황평가를 뒷받침하지만, 향후 범위와 지속성은 아직 확정되지 않았습니다.

아직 확인되지 않은 점:
- 이번 교전을 전면전의 완전한 재개로 단정할 수 있는지는 아직 확인되지 않았습니다.

시장 전달경로(인과 확정 아님):
- `oil_shipping`: 원유와 해운은 호르무즈 운항 위험을 통해 영향을 받을 수 있지만, 관측 가격 움직임의 원인을 이번 사건 하나로 단정하지 않습니다.
- `hormuz`: 해상 자산·기뢰 능력 타격과 상선 공격 맥락 때문에 호르무즈 운항·보험·물류 위험을 우선 점검합니다.
- `usd_rates`: 달러와 금리의 안전자산 반응 가능성은 있으나 실제 방향과 원인은 시장 데이터 교차검증 전까지 확정하지 않습니다.
- `equity_risk_appetite`: 주식 위험선호 약화 가능성을 점검하되, 지수·섹터 움직임을 사건 단독 효과로 해석하지 않습니다.
- `defense`: 방산 관련 관심이 높아질 수 있지만 종목 가격 반응·수주·실적 연결은 별도 증거가 있어야 합니다.

Generated at: 2026-09-02T00:57:29Z
Component status counts: {'PENDING': 17, 'DATA_BLOCKED': 3, 'UNKNOWN': 0, 'DEGRADED': 0, 'POLICY_BLOCKED': 12, 'UNAVAILABLE': 1, 'READY': 13}
...
### KRX · 한국
- session: FRESH_CLOSE_PENDING; evidence_date=2026-08-31
...
### Crypto · 코인
- session: CONTINUOUS_EVIDENCE_PENDING; evidence_dates=2026-09-02,2026-09-02,UNKNOWN
...
- comparison_observation_dates: ['2026-08-31']
...
- **KOFIA_FIRST_SEEN**: POLICY_BLOCKED — SOURCE_AVAILABLE_AT_AND_API_UNIT_UNRATIFIED
    - captured_at=2026-09-02T00:41:34Z available_at=None
  - source: `evidence/kofia/first_seen/2026-09-02/run-33576349430-attempt-1`
...
- **KOREA_MARKET_SIGNALS**: OK
    - 한국 종가 수치 보류: 최신 보존 관측일=2026-08-31; 2026-09-02 종가로 재표기하지 않음
...
- **THREE_MARKET_REGIME_HEADER**: PENDING — LIVE_AXIS_EVIDENCE_WIRED_REGIME_SCORING_UNRATIFIED
  ...
  - sha256: `c809442aaeb0d8bef87ba909f9589753e0b000186619dc6fa31ff92e22cdc203`

## Rotation / Theme
- **ROTATION_DISCOVERY**: PENDING — DART_OBSERVATIONS_PRESENT_ESCALATION_BLOCKED
    - rotation_changes=0 discovery_cases=15 new_candidates=0 existing_candidate_changes=0 signal_observations=48 dart_observations=5 ready=0 entry=0
    ...
    - signal_markets={'BTC': 0, 'CRYPTO': 43, 'KOREA': 5} tier_diagnostic_only={'IMMEDIATE_REVIEW': 0, 'WATCH_REVIEW': 48, 'OBSERVATION_ONLY': 0} promotion=NOT_AUTHORIZED
    - wildcard_observations=0 cases=0 pending=0 importance=UNRATIFIED promotion=NOT_AUTHORIZED
  - sha256: `626667dc2276e67122ddc737b1e88566260a6cc3a9cc22f1193d250f945765e1`
...
- **BUSINESS_ACCELERATION**: PENDING — RADAR_CASE_RECORDED_IMPORTANCE_AND_RANKING_UNRATIFIED
  ...
  - sha256: `0d1a48dcef64efe3408bd6a67c3421cbdd96a6b51cba2f95eefd9855d2fe8f10`
...
- **CASH_EXPOSURE_US**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
  ...
  - sha256: `baa806704dbb4e2104bada5a78560d61b2def878b3475932709086543bf237fa`
- **CASH_EXPOSURE_KOREA**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN cash_action=None evaluation_status=NOT_EVALUATED
  - sha256: `d7b7a1618d8ff8fd3aa59198a96285bd772ff7719cf6b69e009c36fd36c2c0d2`
- **CASH_EXPOSURE_CRYPTO**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN cash_action=None evaluation_status=NOT_EVALUATED
  - sha256: `aef7ee232759b3de96a5f6ea789c657eaf1768ad6ec0d013ae51acd8c809476c`
- **INVERSE_US**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `62596186a57082fe5f8fe1ce9631974cac34011d9143ba6732ffcc713d30754f`
- **INVERSE_KOREA**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `b3fb8ee9def3059d591ba7ebfdb2e344370e1d4b8d0ced3ebc17a428697d9472`
- **INVERSE_CRYPTO**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `cd94f1a1bb1afeeaf1c5dd96ad9880e906d46503768d7ffcbfdf14f1cc1e4f16`
...
- **STRATEGIC_CAPITAL_POSTURE**: PENDING — 1/9_SOURCES_AVAILABLE_POLICY_NOT_RATIFIED
  ...
  - sha256: `6533460ddd79969d8514dd1969f5f29c09ab4b323b3fd68351a23e36c08eb4c7`
...
- **INVESTMENT_DECISION_REVIEW**: POLICY_BLOCKED — P5_OR_THESIS_AUTHORITY_NOT_AVAILABLE
  ...
  - sha256: `8cdcdaf74367c43409a496223f740a02a5fdf8aba745c3618d560aa263674ca6`
...
- **ACTION_BOUNDARY**: OK — DYNAMIC_CLOCK_SIGNAL_OBSERVATIONS_BOUND_READY_NOT_EVALUATED_NO_ACTION_AUTHORITY
  - sha256: `c1ef28ce91bff68d7cb17c67c2995c001872b0693af594a4c5a8cb002767c7c6`
- **UNIFIED_DECISION**: PENDING — 4/6_COMPONENTS_AVAILABLE
  ...
  - sha256: `a2ae222b9fe9272098177e109b22e053468e903a3c3cadb81f09e84dbe819951`
- **DEFENSIVE_ACTION_DECISION**: PENDING — 7/12_SOURCES_AVAILABLE_POLICY_NOT_RATIFIED
  ...
  - sha256: `6bf6b5918b324f6d8203ce9b21f33b782a5d0a358a73eaef7efc4436b60858a2`
- **ACTION_RISK_PORTFOLIO_SUMMARY**: PENDING — MOST_UPSTREAM_SOURCES_NOT_YET_LIVE
  ...
  - sha256: `8b396be06657f4fe90d2153057c14ebef4012553963bf8e4e36548b80c099fea`
...
- **INVESTMENT_REVIEW_SHADOW**: POLICY_BLOCKED — NO_RATIFIED_PASS_REVIEW_TO_RECORD
  ...
  - sha256: `72ddf2a3a5a299799c8232fd1310db9248d48c8ddf1d66bd68e44355846c38ac`
...
- **FORWARD_ALPHA_REVIEW**: OK
  ...
  - sha256: `725b1ef9f6a2e952a2146d6914eb329d41f2fd673660dff5e55363e7b1310aea`
...
- **DYNAMIC_CLOCK**: OK
    ...
    - CRYPTO: raw_triggers(audit only)=53 immediate_review=0 watch_review=43 observation_only=0 expired=189 calendar_confidence=VERIFIED_24_7 not_computable=['CATALYST_APPROACH', 'EXPECTATION_DISLOCATION', 'FLOW_REVERSAL', 'FUNDAMENTAL_REVISION']
      ...
      - WATCH_REVIEW DASH/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_as_of=UNKNOWN next_review_at=2026-09-02 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      - WATCH_REVIEW DCR/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_as_of=UNKNOWN next_review_at=2026-09-02 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      - WATCH_REVIEW ENA/USD trigger_types=['RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_as_of=UNKNOWN next_review_at=2026-09-01 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
      - WATCH_REVIEW ESPORTS/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_as_of=UNKNOWN next_review_at=2026-09-02 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      - ... +28 more WATCH_REVIEW candidates (full list: evidence/operational/dynamic_clock/briefing_section.json)
  ...
  - sha256: `ceca39d6402d1269a631faea6f75fd74105e54b5b0d769f987cab6fb3ab89cc8`
...
<!-- atlas-delivery-id: 2026-09-02-am/rev-002 -->
