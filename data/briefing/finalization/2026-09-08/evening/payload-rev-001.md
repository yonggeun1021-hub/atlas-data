# Atlas Daily Briefing — 2026-09-08 (evening)

Generated at: 2026-09-08T09:41:41Z
Component status counts: {'DEGRADED': 0, 'UNKNOWN': 0, 'READY': 14, 'UNAVAILABLE': 1, 'PENDING': 17, 'POLICY_BLOCKED': 14, 'DATA_BLOCKED': 1}
...
- latest_observed_unconfirmed_date: 2026-09-08
...
### US · 미국
- session: INDEPENDENT_SESSION_PENDING; evidence_date=2026-09-04
- latest_verified_us_session_date: 2026-09-04
- latest_verified_vix_observation_date: 2026-09-03
- US close/sector/event summary: pending independently dated validated US session evidence; no KRX-date substitution.
### Crypto · 코인
- session: CONTINUOUS_EVIDENCE_PENDING; evidence_dates=BTC_TREND=2026-09-07,BTC_RISK=2026-09-07,STABLECOIN_NET_ISSUANCE=2026-09-08
...
- comparison_observation_dates: ['2026-09-03', '2026-09-08']
...
- **KRX_PREOPEN_COMPACT**: OK
    - krx: ok=7 failed=0 date=2026-09-08
    - dart: ok=7 failed=0 date=2026-09-08
    - sec: ok=7 failed=0 date=2026-09-08
  - source: `data/latest_krx.json`
  - sha256: `57a02e1f4ec3823ff304d9cc37fe98add553a0d3b15d8c28057e13987fb30b81`
- **KRX_POST_CLOSE**: OK
    - observed_unconfirmed: symbols=7 decision_eligible=0 confirmed_same_day=0
  - sha256: `1e8dfe48f5772d0c5fc08a60f9a8b9ef1bd7e5df334a42bc17661f250bf2b273`

## Filing & source evidence
- **DART_FILING_CONTENT**: OK
    - records=2 run_status=OK
  - source: `data/latest_dart_content.json`
  - sha256: `b3de71db121314e4a43a9380391adf9b7daaad48edb594c343fda412c74e2fc4`
- **SEC_FILING_CONTENT**: OK
    - records=15 run_status=OK
  - source: `data/latest_sec_content.json`
  - sha256: `b7d9559b5182c80ff30a2c32a202759dd9efb0f12ca54195b9983ed2c24d3df7`
- **KOFIA_FIRST_SEEN**: POLICY_BLOCKED — SOURCE_AVAILABLE_AT_AND_API_UNIT_UNRATIFIED
    - captured_at=2026-09-08T08:38:04Z available_at=None
  - source: `evidence/kofia/first_seen/2026-09-08/run-34205525907-attempt-1`
...
- **FREE_MARKET_DATA**: OK
    - clocks: market_session=2026-09-04 VIXCLS_observation=2026-09-03
    - US close values withheld: independent session evidence is dated 2026-09-04, not 2026-09-08
    - VIXCLS=14.32 as_of=2026-09-03
    - scope: IEX_PARTIAL_EVIDENCE_ONLY_NOT_MARKET_WIDE_OR_TRADE_AUTHORITY
  - source: `data/latest_free_market_data.json`
  - sha256: `e365be6d00624c1a5cd0ebc8d2191b5f6b71ef104d7de1c63789a83a2df312d3`
- **BTC_TREND**: OK
    - direction=ABOVE_200DMA 200dma=69815.749
  - source: `evidence/crypto/btc/raw/2026-09-08`
- **BTC_RISK**: OK
    - current_drawdown=-0.026893514822 max_drawdown=-0.116956805759 realized_vol_annualized=0.491256556551
  - source: `evidence/crypto/btc/raw/2026-09-08`
- **STABLECOIN_NET_ISSUANCE**: OK
    - 2026-09-08: daily_net_issuance=-289786471.42 (AVAILABLE), weekly_net_issuance=1440080061.58 (AVAILABLE)
  - source: `evidence/stablecoin/raw/2026-09-08`
- **CRYPTO_BREADTH**: POLICY_BLOCKED — TAXONOMY_COVERAGE_UNKNOWN
    - status=UNKNOWN selected_assets=0
    - taxonomy_coverage: known_eligible=100 resolved_cutoff_slots=94 target=100 coverage_ratio_bps=9400 unresolved_before_cutoff=['CHIP', 'DRV', 'NPC', 'QUID', 'RAY', 'SN8']
  - source: `evidence/crypto/breadth/raw/2026-09-08`
...
- **KOREA_MARKET_SIGNALS**: OK
    - 한국 종가 수치 보류: 최신 보존 관측일=2026-09-07; 2026-09-08 종가로 재표기하지 않음
...
- **THREE_MARKET_REGIME_HEADER**: PENDING — LIVE_AXIS_EVIDENCE_WIRED_REGIME_SCORING_UNRATIFIED
  ...
  - sha256: `cd30bba12dc302b1ed598f7674e7584b406d63b8752de63988ea92d9a167f754`

## Rotation / Theme
- **ROTATION_DISCOVERY**: PENDING — DART_OBSERVATIONS_PRESENT_ESCALATION_BLOCKED
    - rotation_changes=0 discovery_cases=18 new_candidates=0 existing_candidate_changes=0 signal_observations=95 dart_observations=2 ready=0 entry=0
    ...
    - DART observations=2 raw_verified=0 metadata_only=2 source_failed=0 content_failed=0 event_type=UNRATIFIED importance=UNRATIFIED promotion=NOT_AUTHORIZED
    ...
    - signal_markets={'BTC': 0, 'CRYPTO': 90, 'KOREA': 5} tier_diagnostic_only={'IMMEDIATE_REVIEW': 0, 'WATCH_REVIEW': 95, 'OBSERVATION_ONLY': 0} promotion=NOT_AUTHORIZED
    - wildcard_observations=0 cases=0 pending=0 importance=UNRATIFIED promotion=NOT_AUTHORIZED
  - sha256: `adb7f3b8dfb0521eaf26688360ec95964fe15fa17a4d1fa0a7390f5758b80b0e`
...
- **BUSINESS_ACCELERATION**: PENDING — RADAR_CASE_RECORDED_IMPORTANCE_AND_RANKING_UNRATIFIED
  ...
  - sha256: `7dc4bf26d89f9d8ca7235acd821074cd6cad1c71c0f88847431861bd459ff799`
...
- **CASH_EXPOSURE_US**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
  ...
  - sha256: `3ba3ce5a9804fefbf2bd1e2945e0f60fa0fcaeff98e5d6d501c69b53f23e9ada`
- **CASH_EXPOSURE_KOREA**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN cash_action=None evaluation_status=NOT_EVALUATED
  - sha256: `48e21973364f00120a2c12cc5b53dbb141b00cd6a17621af8a5ba99606d50ab3`
- **CASH_EXPOSURE_CRYPTO**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN cash_action=None evaluation_status=NOT_EVALUATED
  - sha256: `ed85a3480fb57a4670672431752bdc2ebf1288b7d908c79b9836268f8dde7510`
- **INVERSE_US**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `bdf754192d161eb70584e3a90803285e5d02c9203983fbb4dc97952810c84fad`
- **INVERSE_KOREA**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `317441b143aca38bae7d2cf8827111fd9e58e1072e07709749be29243dbd9022`
- **INVERSE_CRYPTO**: PENDING — REGIME_UNKNOWN_NOT_EVALUATED
    - regime=UNKNOWN inverse_signal=None invariant_status=ENFORCED
  - sha256: `ccf0ec925a8a3920885ca0bd510c1a70e214cdd623803a7681c864f421769532`
...
- **P2_FLOW_ENGINE**: PENDING — FLOW_REFERENCE_IS_DIAGNOSTIC_NOT_A_DEFENSIVE_ACTION_DECISION
  - sha256: `7fe05ec0137c119221387f219e8232543a6b76f839e1574a75e3de8b7079151b`
- **STRATEGIC_CAPITAL_POSTURE**: PENDING — 2/9_SOURCES_AVAILABLE_POLICY_NOT_RATIFIED
  ...
  - sha256: `3716e557bf9c0d60c35991f95b66ce5984d0a9f353af466331f2bc2030e2d0c4`
...
- **INVESTMENT_DECISION_REVIEW**: POLICY_BLOCKED — P5_OR_THESIS_AUTHORITY_NOT_AVAILABLE
  ...
  - sha256: `8eb810274087780e3b6f568cb454ca41d2c05c8487975317994018197ab489e8`
...
- **ACTION_BOUNDARY**: OK — DYNAMIC_CLOCK_SIGNAL_OBSERVATIONS_BOUND_READY_NOT_EVALUATED_NO_ACTION_AUTHORITY
  - sha256: `7ca852826f4f04af9fea67c2d6de0c12bf2705f31047c2b301c40cdb3a737f15`
- **UNIFIED_DECISION**: PENDING — 4/6_COMPONENTS_AVAILABLE
  ...
  - sha256: `e0fd059666202f5b957385f2980781614e7e98afd1fd7512b95c6a232d32fb41`
- **DEFENSIVE_ACTION_DECISION**: PENDING — 8/12_SOURCES_AVAILABLE_POLICY_NOT_RATIFIED
  ...
  - sha256: `4d84fc8a291643cd8674a2d4accb29d2aababe655b2520ff875a4d9d1e0580b5`
- **ACTION_RISK_PORTFOLIO_SUMMARY**: PENDING — MOST_UPSTREAM_SOURCES_NOT_YET_LIVE
  ...
  - sha256: `da360030fe54f6f94b9c387c4db0600b9fcda8d5369051b640a13a7fe48f86bb`
...
- **INVESTMENT_REVIEW_SHADOW**: POLICY_BLOCKED — NO_RATIFIED_PASS_REVIEW_TO_RECORD
  ...
  - sha256: `b655ce8348f743122f23c5d2f5b98cd54654c8b7ccb425118a770a149bc98cb2`
...
- **FORWARD_ALPHA_REVIEW**: OK
  ...
  - sha256: `874d054d6bbd877abe8574f1213daec19326af85664c8f7474b2a9abbbcf6ec6`
...
- **DYNAMIC_CLOCK**: OK
    ...
    - CRYPTO: raw_triggers(audit only)=134 immediate_review=0 watch_review=90 observation_only=0 expired=278 calendar_confidence=VERIFIED_24_7 not_computable=['CATALYST_APPROACH', 'EXPECTATION_DISLOCATION', 'FLOW_REVERSAL', 'FUNDAMENTAL_REVISION'] review_overdue=10 review_due_today=35 review_upcoming=45
      - WATCH_REVIEW ACU/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_UPCOMING next_review_at=2026-09-09 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      - WATCH_REVIEW ADA/USD trigger_types=['RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_DUE_TODAY next_review_at=2026-09-08 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
      ...
      - WATCH_REVIEW AKE/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_OVERDUE next_review_at=2026-09-07 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      - WATCH_REVIEW AKT/USD trigger_types=['RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_UPCOMING next_review_at=2026-09-09 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
      ...
      - WATCH_REVIEW APR/USD trigger_types=['RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_OVERDUE next_review_at=2026-09-07 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
      - WATCH_REVIEW APT/USD trigger_types=['RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_UPCOMING next_review_at=2026-09-09 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
      - WATCH_REVIEW ARB/USD trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=UNKNOWN reflection_status=UNKNOWN data_state=NOT_LINKED threshold_basis=N/A price_observation_date=UNKNOWN price_captured_at=UNKNOWN review_due=REVIEW_DUE_TODAY next_review_at=2026-09-08 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: no thesis or price-reflection linkage exists yet
      ...
      - ... +75 more WATCH_REVIEW candidates (full list: evidence/operational/dynamic_clock/briefing_section.json)
    - KOREA: raw_triggers(audit only)=10 immediate_review=0 watch_review=5 observation_only=0 expired=17 calendar_confidence=UNVERIFIED_NO_HOLIDAY_CALENDAR not_computable=['CATALYST_APPROACH', 'EXPECTATION_DISLOCATION', 'FUNDAMENTAL_REVISION'] review_overdue=2 review_due_today=1 review_upcoming=2
      - WATCH_REVIEW 000660 trigger_types=['FLOW_REVERSAL', 'PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=OVEREXTENDED reflection_status=UNKNOWN data_state=REFLECTION_UNCERTAIN_WITH_VALID_PRICE threshold_basis=PROVISIONAL price_observation_date=2026-09-07 price_captured_at=2026-09-07T21:00:10Z review_due=REVIEW_DUE_TODAY next_review_at=2026-09-08 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=3 independent trigger types, but capped at WATCH_REVIEW: price_reflection is linked (price_state=OVEREXTENDED) but threshold_basis=PROVISIONAL -- PROVISIONAL diagnostics never elevate tier; no thesis linkage exists either
      - WATCH_REVIEW 005930 trigger_types=['FLOW_REVERSAL', 'RELATIVE_STRENGTH_REVERSAL'] price_state=STRONG_MOMENTUM reflection_status=UNKNOWN data_state=REFLECTION_UNCERTAIN_WITH_VALID_PRICE threshold_basis=PROVISIONAL price_observation_date=2026-09-07 price_captured_at=2026-09-07T21:00:10Z review_due=REVIEW_OVERDUE next_review_at=2026-09-07 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: price_reflection is linked (price_state=STRONG_MOMENTUM) but threshold_basis=PROVISIONAL -- PROVISIONAL diagnostics never elevate tier; no thesis linkage exists either
      - WATCH_REVIEW 034020 trigger_types=['PRICE_CONFIRMATION', 'RELATIVE_STRENGTH_REVERSAL'] price_state=STRONG_MOMENTUM reflection_status=UNKNOWN data_state=REFLECTION_UNCERTAIN_WITH_VALID_PRICE threshold_basis=PROVISIONAL price_observation_date=2026-09-07 price_captured_at=2026-09-07T21:00:10Z review_due=REVIEW_UPCOMING next_review_at=2026-09-09 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: price_reflection is linked (price_state=STRONG_MOMENTUM) but threshold_basis=PROVISIONAL -- PROVISIONAL diagnostics never elevate tier; no thesis linkage exists either
      - WATCH_REVIEW 267260 trigger_types=['FLOW_REVERSAL', 'INVALIDATION_TRIGGER'] price_state=WEAK reflection_status=UNKNOWN data_state=REFLECTION_UNCERTAIN_WITH_VALID_PRICE threshold_basis=PROVISIONAL price_observation_date=2026-09-07 price_captured_at=2026-09-07T21:00:10Z review_due=REVIEW_OVERDUE next_review_at=2026-09-07 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=2 independent trigger types, but capped at WATCH_REVIEW: price_reflection is linked (price_state=WEAK) but threshold_basis=PROVISIONAL -- PROVISIONAL diagnostics never elevate tier; no thesis linkage exists either
      - WATCH_REVIEW 298040 trigger_types=['FLOW_REVERSAL'] price_state=MODERATE reflection_status=UNKNOWN data_state=REFLECTION_UNCERTAIN_WITH_VALID_PRICE threshold_basis=PROVISIONAL price_observation_date=2026-09-07 price_captured_at=2026-09-07T21:00:10Z review_due=REVIEW_UPCOMING next_review_at=2026-09-09 authority=REVIEW_ONLY money_action=NONE reason=confirmation_count=1 -- below the independent-confirmation threshold of 2
  - sha256: `bd358413957c42e2d3844084f78b2f686a69312894e920fdf4e8f8522aefce95`
...
## Investment review delivery — evening 2026-09-08
...
<!-- atlas-delivery-id: 2026-09-08-pm/rev-001 -->
