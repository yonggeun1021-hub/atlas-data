...
def run_case(fail_sid=None):
    with tempfile.TemporaryDirectory() as td:
        ...
        return cp.returncode, cp.stdout, finals, logs, summaries
...
rc, out, finals, logs, summaries = run_case()
...
rc, out, finals, logs, summaries = run_case("TOTBKCR")
...
rc, out, finals, logs, summaries = run_case("WRESBAL")
