...
def _expected_contract() -> dict:
    return {
        "schema_version": 2,
        "contract_version": "three_market_shadow_ledger/2",
        "ledger_schema_version": "three_market_shadow_ledger_packet/2",
        ...
        "intraday_risk_schema_version": "intraday_risk_escalation_packet/1",
        "intraday_risk_contract_version": "intraday_risk_escalation/1",
