...
def _expected_contract() -> dict:
    return {
        "schema_version": 5,
        "contract_version": "atlas_legacy_comparison/5",
        "legacy_batch_schema_version": "legacy_judgment_batch/5",
        "outcome_batch_schema_version": "comparison_outcome_batch/5",
        "output_schema_version": "atlas_legacy_comparison_packet/5",
        "shadow_ledger_schema_version": "three_market_shadow_ledger_packet/4",
