...
def _us_price_points(
    ...
    committed day. v1/v2 stored the manifest below ``raw``; v3/v4/v5 store the
    ...
    for manifest_path in sorted(manifest_paths):
        ...
        if (
            ...
            or (schema_version in {"free_market_data_capture/3", "free_market_data_capture/4", "free_market_data_capture/5"} and alpaca.get("status") != "READY")
        ):
            continue
