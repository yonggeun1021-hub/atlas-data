...
The source-age value literally reuses the existing human-approved KIS PAPER
decision-age default, and the pair-gap value reuses that path's human
confirmation TTL default, from private merge
`72300ef09b4b8ce501588492e970f9e24bd9c4db`.
The reviewer does not trust that statement or a content hash alone: it reads
...
the strict `age > maximum` stale comparison. This operating precedent is evidence for
review, not freshness-policy authority.
