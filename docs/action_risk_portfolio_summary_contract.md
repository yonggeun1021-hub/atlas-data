...
action, target, size, hedge, or order content.
...
Available P7 breach arrays are displayed as risk findings. A concentration,
market/theme, Crypto, or planned-loss breach remains evidence, not a reduction
or exit instruction. Unavailable optional policies stay explicit with reason
codes; the unified daily decision is the only required source.
