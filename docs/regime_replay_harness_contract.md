...
classification, direction, confidence, stress override, invalidation,
hysteresis, and replay acceptance carry exact negative evidence but no values.
All eight components remain blocked. The candidate is
