...
by exact `(decision_id, market)` keys. Contract v5 consumes the Shadow ledger v4
chain and embeds the exact Shadow, legacy-judgment, and outcome packets. The
result is self-validating and inherits the exact validated P7-03, P7-06, P9-02,
P9-03, and P9-05 source lineage without interpreting the event, eligibility, or
risk values.
